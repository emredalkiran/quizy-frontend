...
function UserAuthenticateModal (props)  {
  ...
  return (
    <div className={ `modal ${props.open ? "is-active" : ""}` } onMouseDown={ handleBackgroundClick } >
      ...
      <div className="modal-card auth-modal" onMouseDown={ (e)=> handleCardClick(e) }>
        ...
        <section className="modal-card-body" >
          {props.type === 'login' ? (
              <LoginForm onSuccess={ props.onSuccess } close={ props.close } changeModal={ props.changeModal }/>
            ) : props.type === 'signup' ? (
