...
export default function SignupForm(props) {
  ...
  const handleChange = (e) => {
    ...
    let fieldErrorStatus = validateSingleField(
      fieldName,
      e.target.value,
      'signup'
    )
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const credendtials = signupValidationSchema.validateSync(inputs, {
        abortEarly: false
      })
    ...
    <form>
      <div className='login-input-elements-wrapper'>
        ...
        <FormInput
          ...
          blur={() => setTouched({ ...touched, name: true })}
        ...
        <FormInput
          ...
          blur={() => setTouched({ ...touched, lastName: true })}
          change={(e) => handleChange(e)}
        ...
        <FormInput
          ...
          blur={() => setTouched({ ...touched, email: true })}
          change={(e) => handleChange(e)}
        ...
        <FormInput
          ...
          blur={() => setTouched({ ...touched, password: true })}
          change={(e) => handleChange(e)}
        ...
        <p className='mt-4'>
          <span>
            Already a member?{' '}
            <span
              className='link-text has-text-weight-semibold'
